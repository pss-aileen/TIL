...
## 2024/05/27
- **Study Time**
  - Programming: 1.75h / 453.25h
  - English: 3.75h / 23.00h
  - Total: 5.5h
- **Programming**
  - **First Contributions JA** (0.5h)
    - プルリクの確認: done
    - 絵文字の不具合について色々確認: done
  - **my-portfolio** (1.25h)
    - まずSP仕上げる
    - サイドバーの開閉実装: done
    - ヘッダー作成: done
    - 計画通り頑張りました
- **English** (1.5 + 1.75 + 0.5 = 3.75)
  - **金のセンテンス** (1h)
    - 単語ひたすら覚える
  - **金の文法** (0.5h)
    - p.0~p.46
  - **TOEIC TEST1** (1h + 0.75h = 1.75h)
    - Part4 ディクテーション、答え合わせ、シャドーイング等: Q80-88
  - **SpeakBuddy** (0.5h)
    - 全然最近話せてない。英語口に出すことがまだ恥ずかしい感覚。直したい。
    - とにかくめげずに続けていく
- **Memo**
  - 1つのセクションのディクテーションから答え合わせ、シャドーイングまで20分程度
  - 午前中に英語詰め込んで、午後に英語＋プログラミングがバランス良いかも
  - 語彙力増やさないと...と思ったけど、苦手なフレーズのリスニングは公式問題にしかないので、全部頑張らなくてはいけない。
  - 観察していると熟語も弱い。とにかく毎日少しでも単語を覚える必要がある...ということだな...
