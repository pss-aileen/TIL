...
- practice-bootstrap5-food-delivery: ここまでにはとりあえず終わらせたい
  - どうしても実装が難しいものは取り残しても良いので終わらせる
  - ただ、難しい部分を放置しないこと、かならずどこかのタイミングでやること
...
- React と Bootstrap を使って、カンパニーサイトを作る、シングルページで OK
