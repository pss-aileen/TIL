...
- want to do
  - DMM 英会話 [The World's Largest Rodent: Fun Facts About Capybaras](https://eikaiwa.dmm.com/app/daily-news/article/the-worlds-largest-rodent-fun-facts-about-capybaras/4qknHgB-Ee-eGxsWVsxdBQ)
    - 英語聴きながら、質問に答える
    - Discussion を英語でまとめる
    - とりあえずトライしてみる
  - practice-bootstrap5-code-with-patrick
    - 引き続き動画を 1 つでもすすめる
  - これからはじめる React 実践入門: 少しで良いのですすめる
