...
- practice-bootstrap5-food-delivery: 最優先、ものとして仕上げること
  - 全体微調整
  - アクセシビリティ考慮
- フロントエンドの地図: できていないこと炙り出し、続き
- JavaScript本格入門: 6と7あたりを読む
- ピュアな SASS、Bootstrap, Bootstrap Icons を使った Webサイトを作る時のテンプレートを作る -> メモしようと思ったけど、一応リポ作っておく
- 学んだことを端的にまとめて思い出せるようにしたい
  - 結局TILリポジトリを見返す頻度が多いから、プライベートメモを抽象化しまくって、人にも何か伝えられる内容は英語の練習かねて、リポジトリに色々かていくのがいいかも
...
- React と Bootstrap を使って、カンパニーサイトを作る
