...
- 祝日、頑張る
- Today is a holiday, and I want to try hard.
- practice-bootstrap5-food-delivery: スワイパー実装やり直し、フッター実装、ファビコン等設定
- フロントエンドの地図: できていないこと炙り出し、続き
- ピュアな SASS、Bootstrap を使った Webサイトを作る時のテンプレートを作る -> メモをしておく、何度もないだろうから
